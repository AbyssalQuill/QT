...
Window {
    ...
    GridLayout {
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: sevenButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: eightButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: nineButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: fourButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: fiveButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: sixButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: oneButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: twoButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: threeButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
        ...
        Button {
            ...
            font.pointSize: 18
            background: Rectangle {
                color: zeroButton.pressed ? "#e9ecef" : "#f8f9fa"
                radius: 8
            }
